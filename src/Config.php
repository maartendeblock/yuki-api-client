...
return Config::create()
    ...
    ->setTypeNamespace('MaartenDeBlock\YukiApiClient\Type')
    ->setClientDestination('src')
    ->setClientName('YukiApiClient')
    ->setClientNamespace('MaartenDeBlock\YukiApiClient')
    ->setClassMapDestination('src')
    ->setClassMapName('YukiApiClassmap')
    ->setClassMapNamespace('MaartenDeBlock\YukiApiClient')
