...
class ImportSingleStatementProjectLine implements RequestInterface
{
    /**
     * @var null | string
     */
     ...
     */
    public function __construct(?string $sessionId, ?string $accountGlCode, ?string $transactionCode, ?string $offsetAccount, ?string $offsetName, \DateTimeInterface $transactionDate, ?string $transactionDescription, float $amount, ?string $projectCode, ?string $projectName)
    {
     ...
     * @return static
     */
    public function withProjectName(?string $projectName) : static
    {
        $new = clone $this;
