...
class Documents implements RequestInterface
{
    /**
     * @var null | string
     */
     ...
     */
    public function __construct(?string $sessionID, string $sortOrder, \DateTimeInterface $startDate, \DateTimeInterface $endDate, int $numberOfRecords, int $startRecord)
    {
