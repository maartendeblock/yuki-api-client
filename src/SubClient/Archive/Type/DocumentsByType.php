...
class DocumentsByType implements RequestInterface
{
    /**
     * @var null | string
     */
     ...
     */
    public function __construct(?string $sessionID, int $documentType, string $sortOrder, \DateTimeInterface $startDate, \DateTimeInterface $endDate, int $numberOfRecords, int $startRecord)
    {
