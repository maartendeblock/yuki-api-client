...
class GetTransactionDetails implements RequestInterface
{
    /**
     * @var null | string
     */
     ...
     */
    public function __construct(?string $sessionID, ?string $administrationID, ?string $GLAccountCode, \DateTimeInterface $StartDate, \DateTimeInterface $EndDate, int $financialMode)
    {
