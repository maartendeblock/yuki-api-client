...
class YukiApiFiscalTableClassmap
{
    public static function getCollection() : \Soap\ExtSoapEngine\Configuration\ClassMap\ClassMapCollection
    {
        return new ClassMapCollection(
            new ClassMap('FiscalTableTotals', Type\FiscalTableTotals::class),
            new ClassMap('GetFiscalTable', Type\GetFiscalTable::class),
            new ClassMap('GetFiscalTableResponse', Type\GetFiscalTableResponse::class),
            ...
            new ClassMap('AdministrationsWithInternalCustomerCode', Type\AdministrationsWithInternalCustomerCode::class),
            new ClassMap('AdministrationsWithInternalCustomerCodeResponse', Type\AdministrationsWithInternalCustomerCodeResponse::class),
            new ClassMap('AdministrationsWithInternalCustomerCodeResult', Type\AdministrationsWithInternalCustomerCodeResult::class),
