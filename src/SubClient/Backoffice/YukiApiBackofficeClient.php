...
class YukiApiBackofficeClient
{
     ...
     * @throws SoapException
     */
    public function administrationsWithInternalCustomerCode(\MaartenDeBlock\YukiApiClient\SubClient\Backoffice\Type\AdministrationsWithInternalCustomerCode $parameters) : \MaartenDeBlock\YukiApiClient\SubClient\Backoffice\Type\AdministrationsWithInternalCustomerCodeResponse
    {
        $response = ($this->caller)('AdministrationsWithInternalCustomerCode', $parameters);

        \Psl\Type\instance_of(\MaartenDeBlock\YukiApiClient\SubClient\Backoffice\Type\AdministrationsWithInternalCustomerCodeResponse::class)->assert($response);
        \Psl\Type\instance_of(\Phpro\SoapClient\Type\ResultInterface::class)->assert($response);
