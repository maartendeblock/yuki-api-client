...
class GetSuppliersAndCustomers implements RequestInterface
{
    /**
     * @var null | string
     */
    ...
    /**
     * @var 'Customer' | 'Supplier' | 'Both' | 'None'
     */
     ...
     * @param 'Customer' | 'Supplier' | 'Both' | 'None' $contactType
     */
    public function __construct(?string $sessionID, ?string $domainID, string $searchOption, ?string $searchValue, string $sortOrder, ?\DateTimeInterface $modifiedAfter, string $active, int $pageNumber, string $contactType)
    {
    ...
    /**
     * @return 'Customer' | 'Supplier' | 'Both' | 'None'
     */
     ...
     * @return static
     */
    public function withContactType(string $contactType) : static
    {
        $new = clone $this;
        $new->contactType = $contactType;
